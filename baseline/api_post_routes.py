...
from api_desktop_routes import handle_desktop_post
...
def handle_post(path, data, session):
    ...
    for handler in (handle_admin_post, handle_user_post, handle_node_post, handle_tunnel_post, handle_desktop_post, handle_payment_post):
